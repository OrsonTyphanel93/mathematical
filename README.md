...
\begin{align*}
\frac{\partial P(x, t)}{\partial t} &= -\sum_{i=1}^{d} \frac{\partial}{\partial 
x_i}\left[\exp\left(\sqrt{\alpha(t)}\right) \left[x_i - \exp\left(\sqrt{1 - \alpha(t)}\right)\right] \cdot P(x, t)\right] + \nabla^2 P(x, t) + \sigma(t) \cdot N_2(.).
\end{align*}
